...
dirs = "/Users/davidleifer/Documents/20170101-20190604/Geog531/Assignment2/panda_testing/pandamoniumGIS_part2Section2_build/data/tmean_bil2tif_LaElNeu_analysis"
...
for i in all_files:
  ...
  j = []
  j.append(QgsColorRampShader.ColorRampItem(-16, QtGui.QColor("#f7fbff"), "-16"))
  j.append(QgsColorRampShader.ColorRampItem(-11, QtGui.QColor("#deebf7"), "-11"))
  j.append(QgsColorRampShader.ColorRampItem(-6, QtGui.QColor("#c6dbef"), "-6"))
  j.append(QgsColorRampShader.ColorRampItem(-2, QtGui.QColor("#9ecae1"), "-2"))
  j.append(QgsColorRampShader.ColorRampItem(3, QtGui.QColor("#6baed6"), "3"))
  j.append(QgsColorRampShader.ColorRampItem(8, QtGui.QColor("#4292c6"), "8"))
  j.append(QgsColorRampShader.ColorRampItem(13, QtGui.QColor("#2171b5"), "13"))
  j.append(QgsColorRampShader.ColorRampItem(17, QtGui.QColor("#08519c"), "17"))
  j.append(QgsColorRampShader.ColorRampItem(21, QtGui.QColor("#08306b"), "21"))
  ...
  output_dir = "/Users/davidleifer/Documents/20170101-20190604/Geog531/Assignment2/panda_testing/pandamoniumGIS_part2Section2_build/data/tmean_bil2tif_LaElNeu_analysis_xyz/xyz_" + basename
  html = ".html"
  output_html = "/Users/davidleifer/Documents/20170101-20190604/Geog531/Assignment2/panda_testing/pandamoniumGIS_part2Section2_build/data/tmean_bil2tif_LaElNeu_analysis_xyz/xyz_" + basename + html
...
print("Took this long to run tmean_LaElNeu_analysis_tif2XYZ.py: " + str(finalTime))

...
dst_filename = cwd + '/data/tmean_bil2tif_LaElNeu_analysis/tmeanJanELNin.tif'
...
#https://gis.stackexchange.com/questions/37238/writing-numpy-array-to-raster-file
#write array with gdal
dst_filename = cwd + '/data/tmean_bil2tif_LaElNeu_analysis/tmeanJanLANin.tif'
x_pixels = 1405  # number of pixels in x
y_pixels = 621  # number of pixels in y
driver = gdal.GetDriverByName('GTiff')
dataset = driver.Create(dst_filename,x_pixels, y_pixels, 1,gdal.GDT_Float32)
...
#https://gis.stackexchange.com/questions/37238/writing-numpy-array-to-raster-file
#write array with gdal
dst_filename = cwd + '/data/tmean_bil2tif_LaElNeu_analysis/tmeanJanNeutral.tif'
x_pixels = 1405  # number of pixels in x
y_pixels = 621  # number of pixels in y
driver = gdal.GetDriverByName('GTiff')
dataset = driver.Create(dst_filename,x_pixels, y_pixels, 1,gdal.GDT_Float32)

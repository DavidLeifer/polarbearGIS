...
#/Applications/QGIS-LTR.app/Contents/MacOS/bin/python3 /Users/davidleifer/Documents/20170101-20190604/Geog531/Assignment2/polarbearGIS/gitLab/polarbearGIS/scripts/python/tmean_og_quantile_reclassify.py
#https://numpy.org/doc/stable/reference/generated/numpy.nanquantile.html#numpy.nanquantile

cwd = os.getcwd()
input_raster_folder = cwd + '/data/tmean_bil2tif_resize/'
#input_raster_folder = '/Users/davidleifer/Documents/20170101-20190604/Geog531/Assignment2/data/tmean_bil2tif_resize'
...
for input_raster in input_raster_folder_list:
    ...
    print(outname)
print("tmean_og_quantile_reclassify.py complete")

...
example_tif = cwd + "/data/ppt/PRISM_ppt_stable_4kmM3_201001_bil/PRISM_ppt_stable_4kmM3_201001_bil.bil"
...
dst_filename = cwd + '/data/ppt_elnino_minus_neutral/ppt_elnino_minus_neutral.tif'
...
#write array with gdal
dst_filename = cwd + '/data/ppt_lanina_minus_neutral/ppt_lanina_minus_neutral.tif'
x_pixels = 1405  # number of pixels in x
y_pixels = 621  # number of pixels in y
driver = gdal.GetDriverByName('GTiff')
dataset = driver.Create(dst_filename,x_pixels, y_pixels, 1,gdal.GDT_Float32)
...
print("finished ppt_LaElNeu_diff.py")